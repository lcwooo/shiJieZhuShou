...
public class CollectMovieAdapter extends BaseDBRVAdapter<XmlMovieBean, ItemCollectMoviesBinding> {
    public CollectMovieAdapter() {
        super(R.layout.item_collect_movies, BR.bean);
    }

    @Override
    protected void initData(ItemCollectMoviesBinding binding, XmlMovieBean xmlMovieBean, int position) {
