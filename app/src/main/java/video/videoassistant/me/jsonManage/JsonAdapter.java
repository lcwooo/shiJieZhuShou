...
public class JsonAdapter extends
        RecyclerView.Adapter<JsonAdapter.ItemViewHolder> implements IItemTouchHelperAdapter {

    private List<JsonEntity> mList;
    private final OnStartDragListener mDragListener;
    private Context mContext;

    public JsonAdapter(List<JsonEntity> list, Context context, OnStartDragListener mDragListener) {
        mList = list;
    ...
    public void onBindViewHolder(final ItemViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        JsonEntity entity = mList.get(position);
    ...
    public List<JsonEntity> getSortList() {
        return mList;
    }
}
