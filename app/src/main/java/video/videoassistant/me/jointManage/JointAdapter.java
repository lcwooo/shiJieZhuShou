...
public class JointAdapter extends
        RecyclerView.Adapter<JointAdapter.ItemViewHolder> implements IItemTouchHelperAdapter {

    private List<JointEntity> mList;
    private final OnStartDragListener mDragListener;
    private Context mContext;

    public JointAdapter(List<JointEntity> list, Context context, OnStartDragListener mDragListener) {
        mList = list;
    ...
    public void onBindViewHolder(final ItemViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        JointEntity entity = mList.get(position);
    ...
    public List<JointEntity> getSortList() {
        return mList;
    }
}
